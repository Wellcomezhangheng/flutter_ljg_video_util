...
import 'package:luojigou_image_picker/video_cut/thumbnail_viewer.dart';
import 'package:luojigou_image_picker/video_cut/video_editor_cut.dart';
import 'package:luojigou_image_picker/video_cut/video_editor_painter.dart';
...
class _VideoEditorState extends State<VideoEditor> with TickerProviderStateMixin {
  ...
  Future<void> _initializeVideoController() async {
    if (_videoFile != null) {
      ...
      if (_videoDuration > widget.maxCutDuring.toInt()) {
        _videoEndPos = widget.maxCutDuring;
        _endPos = Offset(widget.maxCutDuring/_videoDuration.toDouble()*_thumbnailViewerW, _thumbnailViewerH);
      } else {
      ...
      _scrubberAnimation = _linearTween.animate(_animationController)..addListener(() {
        setState(() {});
  ...
  void initState() {
    ...
    _videoFile = VideoCut.currentVideoFile;
...
//                      style: widget.durationTextStyle),
                  ...
                  Text(
                      '截取时长: '+ Duration(milliseconds: (_videoEndPos - _videoStartPos).toInt())
                          .toString()
                          .split('.')[0],
                      style: widget.durationTextStyle),
...
//                  ),
              ...
              : Container(),
          CustomPaint(
            foregroundPainter: VideoEditorPainter(
              startPos: _startPos,
              endPos: _endPos,
